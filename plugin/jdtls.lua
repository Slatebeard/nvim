...
--  local opts = require("util").opts
  ...
  map("n", "<leader>cev", "<cmd>lua require('jdtls').extract_variable()<cr>", {desc = "Extract variable"})
  map("n", "<leader>cec", "<cmd>lua require('jdtls').extract_constant()<cr>", {desc = "Extract constant"})

  map("v", "<leader>cev", "<esc><cmd>lua require('jdtls').extract_variable(true)<cr>", {desc = "Extract variable"})
  map("v", "<leader>cec", "<esc><cmd>lua require('jdtls').extract_constant(true)<cr>", {desc = "Extract constant"})
  map("v", "<leader>cem", "<esc><cmd>lua require('jdtls').extract_method(true)<cr>", {desc = "Extract method"})
end
